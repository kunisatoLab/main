---
title: "Docker-composeを使ってAzure上に複数のサービス(Rstudio, Jupyter notebook, JATOS, elabFTW，shiny)を展開する方法"
output: html_document
---

## はじめに

[Docker-composeを使ってGCE上の複数のサービス(Rstudio, Jupyter notebook, JATOS, elabFTW，shiny)をHTTPS化する方法](https://kunisatolab.github.io/main/how-to-docker-compose-https.html)は，Google Compute EngineのVM上でdocker-composeを使って，複数のサービス(Rstudio, Jupyter notebook, JATOS, elabFTW，shiny)を利用する方法を解説しています。以下では，Azureで同様のこと行う方法を整理してみます。


なお，国里は，サーバーに関して専門的な教育を受けたことはないので，間違っている部分も多いかと思います（雰囲気で動かしています）。本ページを参考に作業された結果，何らかの問題が生じた場合に，国里は責任を負えません。予めご了承ください（Azureを使用すると課金されますので，慎重に作業ください）。また，お詳しい方は，誤りを見つけられましたら，ご指摘いただけましたら幸いです。

## 1. Azureを使えるようにする

[Azure の無料アカウントを今すぐ作成しましょう](https://azure.microsoft.com/ja-jp/free/search/?&ef_id=Cj0KCQjwv5uKBhD6ARIsAGv9a-whRIoTM98n-zb93e2KEXcyS_aPYbSmJgplgKGVxSHq9H94ZosaXQQaAgBCEALw_wcB:G:s&OCID=AID2200208_SEM_Cj0KCQjwv5uKBhD6ARIsAGv9a-whRIoTM98n-zb93e2KEXcyS_aPYbSmJgplgKGVxSHq9H94ZosaXQQaAgBCEALw_wcB:G:s&gclid=Cj0KCQjwv5uKBhD6ARIsAGv9a-whRIoTM98n-zb93e2KEXcyS_aPYbSmJgplgKGVxSHq9H94ZosaXQQaAgBCEALw_wcB)からアカウントを作成します。


私はMicrosoftの認証でこけることがたまにあって，ちょっと苦労しました・・・
