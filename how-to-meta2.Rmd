...
# サンプリング
fit_fixed_net_mcmc <- fit_fixed$sample(
  data=list(ld = ld, 
            nct = 6, 
            ns = 36, 
            study = study, 
...
|d[3]            |-0.043  |0.047     |1.000|
|d[4]            |-0.111  |0.060     |1.000|
|d[5]            |-0.152  |0.077     |1.000|
|d[6]            |-0.475  |0.100     |1.000|

今回は省略をしますが，各種MCMCの収束判断には，bayesplotをつかうのが便利です。
