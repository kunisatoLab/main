    ...
    timeline:[{
      ...
      stimulus: function(){
        ...
        if (last_select==0 && last_left_right_s1 == 1){
           return "<p style='position: absolute; top: 35%;left: 20%'><img src='stimuli/s1s.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 20%'><img src='stimuli/s2.jpeg' width='200px'/></p>"
        } else if (last_select==0 && last_left_right_s1 == 2){
           return "<p style='position: absolute; top: 35%;right: 20%'><img src='stimuli/s1s.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;left: 20%'><img src='stimuli/s2.jpeg' width='200px'/></p>"
        } else if (last_select==1 && last_left_right_s1 == 1){
           return "<p style='position: absolute; top: 35%;left: 20%'><img src='stimuli/s1.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 20%'><img src='stimuli/s2s.jpeg' width='200px'/></p>"
        } else if (last_select==1 && last_left_right_s1 == 2){
           return "<p style='position: absolute; top: 35%;right: 20%'><img src='stimuli/s1.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;left: 20%'><img src='stimuli/s2s.jpeg' width='200px'/></p>"
        } else {
      ...
      stimulus: function(){
        ...
        if (last_select==0 && last_left_right_s1 == 1 && last_reward_s1==1){
           return "<p style='position: absolute; top: 35%;left: 20%'><img src='stimuli/s1s.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 20%'><img src='stimuli/s2.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 45%'><img src='stimuli/reward.jpeg' width='200px'/></p>"
        } else if (last_select==0 && last_left_right_s1 == 1 && last_reward_s1==0){
           return "<p style='position: absolute; top: 35%;left: 20%'><img src='stimuli/s1s.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 20%'><img src='stimuli/s2.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 45%'><img src='stimuli/punishment.jpeg' width='200px'/></p>"
        }else if (last_select==0 && last_left_right_s1 == 2 && last_reward_s1==1){
           return "<p style='position: absolute; top: 35%;right: 20%'><img src='stimuli/s1s.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;left: 20%'><img src='stimuli/s2.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 45%'><img src='stimuli/reward.jpeg' width='200px'/></p>"
        } else if (last_select==0 && last_left_right_s1 == 2 && last_reward_s1==0){
           return "<p style='position: absolute; top: 35%;right: 20%'><img src='stimuli/s1s.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;left: 20%'><img src='stimuli/s2.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 45%'><img src='stimuli/punishment.jpeg' width='200px'/></p>"
        } else if (last_select==1 && last_left_right_s1 == 1 && last_reward_s2==1){
           return "<p style='position: absolute; top: 35%;left: 20%'><img src='stimuli/s1.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 20%'><img src='stimuli/s2s.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 45%'><img src='stimuli/reward.jpeg' width='200px'/></p>"
        } else if (last_select==1 && last_left_right_s1 == 1 && last_reward_s2==0){
           return "<p style='position: absolute; top: 35%;left: 20%'><img src='stimuli/s1.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 20%'><img src='stimuli/s2s.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 45%'><img src='stimuli/punishment.jpeg' width='200px'/></p>"
        }else if (last_select==1 && last_left_right_s1 == 2 && last_reward_s2==1){
           return "<p style='position: absolute; top: 35%;right: 20%'><img src='stimuli/s1.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;left: 20%'><img src='stimuli/s2s.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 45%'><img src='stimuli/reward.jpeg' width='200px'/></p>"
        } else if (last_select==1 && last_left_right_s1 == 2 && last_reward_s2==0){
           return "<p style='position: absolute; top: 35%;right: 20%'><img src='stimuli/s1.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;left: 20%'><img src='stimuli/s2s.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 45%'><img src='stimuli/punishment.jpeg' width='200px'/></p>"
        } else {
           return '<p style="font-size: 48px">時間内に選択を行ってください</p>'
        }
      },
