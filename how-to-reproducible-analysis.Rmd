...
## 再生可能なデータ解析<環境>を記録・準備しよう！

　RやR Markdownを使っていれば大丈夫かというとそうではなくて，Rなどのオープンソースソフトウェアは，急速に発展しており，どんどん新しいパッケージが発表されたり変更が加えられています。そのような状況を踏まえて，Epskamp(2019)は[^5]，再生可能性を低める脅威として以下のようなものを指摘しています。
　
- β版の存在：(よく0.x.xなどで表現される）
...
[renvの日本語解説資料](https://qiita.com/okiyuki99/items/688a00ca9a58e42e3bfa)
[Packratの日本語解説資料](https://qiita.com/uri/items/5d473a5df91954585e62)

### Dockerを用いた解析環境のコンテナ化
