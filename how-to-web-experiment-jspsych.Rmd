...
　プロジェクトはアプリのコンテナとなるので，１つのデータ収集に１つのプロジェクトを割り当てます（1web実験1プロジェクトです）。わかりやすく認知課題名or研究名をプロジェクト名にしてもいいですが，その名前がweb実験時のURLに記載されるので，参加者の回答に影響のない名前を選ぶと良いかと思います。
...
　以上，Firebaseの登録からウェブ実験の準備をして，データ収集まで説明をしました。
　
