...
jsPsychの情報としては，<a href="https://www.jspsych.org/" target="_blank">jsPsychのオフィシャルサイト</a>に豊富にありますし，日本語でも九州大学文学部心理学研究室の黒木大一朗先生の<a href="https://sites.google.com/site/webdeshinri/home" target="_blank">ウェブブラウザで心理学実験と調査jsPsych</a>にて詳細に解説されています[^1]。分からないことがあれば，まず，この２つのサイトを参照すると良いかと思います。
...
また，黒木大一朗先生がjsPsychに関する非常に便利なプラグインのjspsych-psychophysicsを開発されています。あとで紹介するjsPsychRmdでは，jspsych-psychophysicsも使えます。もし，jspsych-psychophysicsを使った場合は，以下の黒木先生の論文を必ず引用してください。
...
早速，RStudioを開きましょう。なお，以降の解説は，<a href="https://kunisatolab.github.io/main/how-to-write-with-rstudio.html" target="_blank">RStudioで卒論・修論を書く準備</a> で，Research Compendiumの準備ができた前提で進めます(国里ゼミのRstudio serverにはすでにjsPsychRmdがインストールされているので省略しますが，まだインストールしてない場合は，<a href="https://github.com/ykunisato/jsPsychRmd" target="_blank">こちら</a>を見て，インストールください)。
...
```
jsPsychRmd::set_jsPsych(folder = "hello", rc = TRUE)
```
