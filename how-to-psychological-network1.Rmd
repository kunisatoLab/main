...
<img style=float:right src="pic/net9.png" width="500">
...
# 新型コロナのゲノム情報ネットワーク
<img style=float:right src="pic/covid.gif" width="600">
.med[国立感染症研究所病原体ゲノム解析研究センターが，新型コロナのゲノム配列からウィルス親子関係を示すネットワークを作成(4/16)]

.med[最初の方に発生する赤は，武漢由来の国内初期のクラスター。左上の赤はヨーロッパ株であり，３月くらいから拡散している]
