...
jsPsychで作った課題とlab.jsで作った課題をJATOS上でまとめて動かしたい状況があるかと思います。例えば，jsPsychでちょっとややこしい行動課題を作って，lab.jsでアンケートを作った場合は，可能ならそれぞれをJATOS上で統合して実行したいと思います。

### jsPsych課題の準備

jsPsych課題は以下のGitHubリポジトリの構造を意識して設定をします。多くの場合，
...
index.htmlの名前を変更して，１つ上の階層におきます。
