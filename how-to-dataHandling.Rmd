...
このような条件を満たすもので，心理学科の学生にも使いやすいものとしては**R**があります。解析データセット作成では，**R**を使いましょう！以下では，(1)jsPsychを用いたWEB実験で得られたJSONファイルの処理，(2)PsychoPyを用いた実験で得られたcsvファイルの処理について解説します。なお，RやRstudioの基本的な使い方については，[R言語の書き方と解析フォルダの準備方法](how-to-R-language.html)で学んでいることを前提とします。
...
[サンプルデータ](materials/stroop.json)をクリックして，ダウンロードしてください
