...
# s1の設定
top_bottom_s1 = "top"
top_bottom_position_s1 = 35
image_path_s1 = "img/s1.jpeg"
image_width_s1 = 200
left_right_position_s1 <- 20
# s2の設定
top_bottom_s2 = "top"
top_bottom_position_s2 = 35
    ...
    timeline:[{
      ...
      stimulus: function(){
        ...
        if (last_select==0 && last_left_right_s1 == 1){
           return "<p style='position: absolute; top: 35%;left: 20%'><img src='img/s1s.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 20%'><img src='img/s2.jpeg' width='200px'/></p>"
        } else if (last_select==0 && last_left_right_s1 == 2){
           return "<p style='position: absolute; top: 35%;right: 20%'><img src='img/s1s.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;left: 20%'><img src='img/s2.jpeg' width='200px'/></p>"
        } else if (last_select==1 && last_left_right_s1 == 1){
           return "<p style='position: absolute; top: 35%;left: 20%'><img src='img/s1.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 20%'><img src='img/s2s.jpeg' width='200px'/></p>"
        } else if (last_select==1 && last_left_right_s1 == 2){
           return "<p style='position: absolute; top: 35%;right: 20%'><img src='img/s1.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;left: 20%'><img src='img/s2s.jpeg' width='200px'/></p>"
        } else {
      ...
      stimulus: function(){
        ...
        if (last_select==0 && last_left_right_s1 == 1 && last_reward_s1==1){
           return "<p style='position: absolute; top: 35%;left: 20%'><img src='img/s1s.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 20%'><img src='img/s2.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 45%'><img src='img/reward.jpeg' width='200px'/></p>"
        } else if (last_select==0 && last_left_right_s1 == 1 && last_reward_s1==0){
           return "<p style='position: absolute; top: 35%;left: 20%'><img src='img/s1s.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 20%'><img src='img/s2.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 45%'><img src='img/punishment.jpeg' width='200px'/></p>"
        }else if (last_select==0 && last_left_right_s1 == 2 && last_reward_s1==1){
           return "<p style='position: absolute; top: 35%;right: 20%'><img src='img/s1s.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;left: 20%'><img src='img/s2.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 45%'><img src='img/reward.jpeg' width='200px'/></p>"
        } else if (last_select==0 && last_left_right_s1 == 2 && last_reward_s1==0){
           return "<p style='position: absolute; top: 35%;right: 20%'><img src='img/s1s.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;left: 20%'><img src='img/s2.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 45%'><img src='img/punishment.jpeg' width='200px'/></p>"
        } else if (last_select==1 && last_left_right_s1 == 1 && last_reward_s2==1){
           return "<p style='position: absolute; top: 35%;left: 20%'><img src='img/s1.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 20%'><img src='img/s2s.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 45%'><img src='img/reward.jpeg' width='200px'/></p>"
        } else if (last_select==1 && last_left_right_s1 == 1 && last_reward_s2==0){
           return "<p style='position: absolute; top: 35%;left: 20%'><img src='img/s1.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 20%'><img src='img/s2s.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 45%'><img src='img/punishment.jpeg' width='200px'/></p>"
        }else if (last_select==1 && last_left_right_s1 == 2 && last_reward_s2==1){
           return "<p style='position: absolute; top: 35%;right: 20%'><img src='img/s1.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;left: 20%'><img src='img/s2s.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 45%'><img src='img/punishment.jpeg' width='200px'/></p>"
        } else if (last_select==1 && last_left_right_s1 == 2 && last_reward_s2==0){
           return "<p style='position: absolute; top: 35%;right: 20%'><img src='img/s1.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;left: 20%'><img src='img/s2s.jpeg' width='200px'/></p> <p style='position: absolute; top: 35%;right: 45%'><img src='img/reward.jpeg' width='200px'/></p>"
        } else {
           return '<p style="font-size: 48px">時間内に選択を行ってください</p>'
        }
      },
