...
var debrief = {
  type: "html-keyboard-response",
  stimulus: function() {
    var s1_reward = jsPsych.data.get().filter({trial_type: "html-button-response", button_pressed: 0}).select('reward_s1').sum();
    var s2_reward = jsPsych.data.get().filter({trial_type: "html-button-response", button_pressed: 1}).select('reward_s2').sum();
