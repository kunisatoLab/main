---
title: "JuliaをRMarkdownで使うテスト"
output: html_document
---

まず，最初に以下のコードをRコンソール上で実行します。
...
そして，最初に使う場合は，StatsPlotsのインストール時のエラーを回避するために，以下の環境変数を設定します。これは，最初にjuliaを使うので，時間がかかります。この操作は初回だけでいいです。
